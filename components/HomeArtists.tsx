        ...
        >
            <div className="artists-content relative top-0 h-screen flex flex-col">
                ...
                <div className="carousel relative flex-1 overflow-hidden flex items-center justify-center">
                                ...
                                <img
                                    ...
                                    style={{
                                        width: i === currentIndex
                                            ? 'clamp(320px, 42vw, 500px)'
                                            : 'clamp(220px, 28vw, 350px)',
                                        height: i === currentIndex
                                            ? 'clamp(220px, 30vw, 350px)'
                    ...
                    <div className="info absolute bottom-15 left-1/2 -translate-x-1/2 w-125 border-t-2 border-b-2 border-black py-4 bg-white text-center text-black z-11"
                        style={{
                            width: 'clamp(320px, 42vw, 500px)',
                        }}
                    >
                        <h2 id="artistName" className="text-2xl font-bold uppercase">
                            {artists[currentIndex].name}
                        </h2>
                        <p id="artistDate" className="text-sm">
             ...
             hover:opacity-85 transition z-20 cursor-pointer"
                        ...
                        style={{
                            ...
                            left: 'calc(48% - clamp(320px, 42vw, 500px)/2)'
                        }}
                    >
                        <div
             ...
             hover:opacity-85 transition z-20 cursor-pointer"
                        ...
                        style={{
                            width: 'clamp(44px, 6vw, 62px)',
                            height: 'clamp(38px, 5vw, 54px)',
                            right: 'calc(48% - clamp(320px, 42vw, 500px)/2)'
                        }}
                    >
                        <div
                            className="w-8.25 h-5.5 bg-black -rotate-270"
